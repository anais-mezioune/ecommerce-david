...
<head>
	...
	<link href="./public/stylesheets/default.css" rel="stylesheet" type="text/css" media="all" />
	<link href="./public/stylesheets/fonts.css" rel="stylesheet" type="text/css" media="all" />
	<!--[if IE 6]>
	...
	<div id="portfolio-wrapper">
		<div id="portfolio" class="container">
			<div id="column1">
				...
				<a href="#" class="image image-full"><img src="./public/images/pic02.jpg" alt="" /></a>
			...
			<div id="column2">
				...
				<a href="#" class="image image-full"><img src="./public/images/pic03.jpg" alt="" /></a>
				<p>Etiam non felis. Donec ut ante. In id eros. Suspendisse lacus turpis, cursus egestas at sem. Mauris quam enim, molestie.</p>
				<a href="#" class="icon icon-arrow-right button">Read More</a> </div>
			<div id="column3">
				<div class="title">
				...
				<a href="#" class="image image-full"><img src="./public/images/pic04.jpg" alt="" /></a>
				<p>Etiam non felis. Donec ut ante. In id eros. Suspendisse lacus turpis, cursus egestas at sem. Mauris quam enim, molestie.</p>
				<a href="#" class="icon icon-arrow-right button">Read More</a> </div>
			<div id="column4">
				<div class="title">
				...
				<a href="#" class="image image-full"><img src="./public/images/pic05.jpg" alt="" /></a>
				<p>Etiam non felis. Donec ut ante. In id eros. Suspendisse lacus turpis, cursus egestas at sem. Mauris quam enim, molestie.</p>
				<a href="#" class="icon icon-arrow-right button">Read More</a> </div>
		</div>
	</div>
